package com.example.alvarado.memoria_int_erivan;
    ...
    public class principal extends ActionBarActivity implements DialogInterface.OnClickListener, View.OnClickListener {
        ...
        public void onClick(View v) {
            ...
            { String str = Texto.getText().toString();
                ...
                Toast.makeText(getBaseContext(),"El Arcivo a sido cargado correctmanete!!!", Toast.LENGTH_SHORT).show(); Texto.setText("");
            }
            if (v.equals(Abrir)){
                try {
